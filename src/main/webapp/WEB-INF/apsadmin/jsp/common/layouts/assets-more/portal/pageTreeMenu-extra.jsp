...
<link rel="stylesheet" type="text/css" href="<wp:ResourceURL ignoreTenant="true" />administration/css/pages/pageTreeMenu.css"/>
...
<script src="<wp:ResourceURL ignoreTenant="true" />administration/js/pages/pageTreeMenu.js"></script>
<script>
